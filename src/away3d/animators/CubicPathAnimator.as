package away3d.animators
{
	...
	import away3d.extrusions.utils.CubicPath;
	import away3d.extrusions.utils.CubicPathSegment;
	import away3d.extrusions.utils.PathUtils;

	import flash.events.EventDispatcher;
	import flash.geom.Vector3D;

	public class CubicPathAnimator extends EventDispatcher
	{
		private var _path:CubicPath;
		 ...
		 */
		function CubicPathAnimator(path:CubicPath = null, target:Object3D = null, offset:Vector3D = null, alignToPath:Boolean = true, lookAtTarget:Object3D = null, rotations:Vector.<Vector3D> = null)
		{
			_index = 0;
			_time = _lastTime = 0;
		...
		public function updateProgress(t:Number):void
		{
			...
			updatePosition(nT, CubicPathSegment(_path.segments[_index]));
		...
		public function getPositionOnPath(t:Number, out:Vector3D):Vector3D
		{
			...
			var i:uint = m;
			var ps:CubicPathSegment = _path.segments[i];
		 ...
		 * @see Path
		 */
		public function set path(p:CubicPath):void
		{
			_path = p;
		...
		public function get path():CubicPath
		{
			return _path;
		}
		...
		public static function calcPosition(t:Number, ps:CubicPathSegment, out:Vector3D):Vector3D
		{
		...
		private function updatePosition(t:Number, ps:CubicPathSegment):void
		{
